...
{
    App* app = new App(GLUT_SINGLE | GLUT_RGB, AlturaVentana,
            AnchuraVentana, COLOR_BLANCO, COLOR_AZUL);

    app->inicializar("Hola mundo");


    glutDisplayFunc(displayMe);
    //cuando cambiar las dimensioens las pantallas
