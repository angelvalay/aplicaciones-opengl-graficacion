...
private:
    ...
    GLfloat ballXMax, ballXMin, ballYMax, ballYMin; // Ball's center (x, y) bounds
public:
    Ball(GLfloat ballX,GLfloat ballY){
        this->ballX = ballX;
        this->ballY = ballY;
    }
    void displayBall(){
    ...
    void animateBall(){
        ...
        if (this->ballX > this->ballXMax) {
            this->ballX = this->ballXMax;
            xSpeed = -xSpeed;
        } else if (ballX < ballXMin) {
            this->ballX = this->ballXMin;
            xSpeed = -xSpeed;
        }
        if (this->ballY > this->ballYMax) {
            this->ballY = this->ballYMax;
            ySpeed = -ySpeed;
        } else if (this->ballY < this->ballYMin) {
            this->ballY = this->ballYMin;
            ySpeed = -ySpeed;
        }
    }
    void reshapeBall(){
    ...
    void increaseRadiusBall(){
        this->ballRadius *= 1.05f;
        this->ballXMin = clipAreaXLeft + this->ballRadius;
        this->ballXMax = clipAreaXRight - this->ballRadius;
        this->ballYMin = clipAreaYBottom + this->ballRadius;
        this->ballYMax = clipAreaYTop - this->ballRadius;
    }
    void decreaseRadiusBall(){
        this->ballRadius *= 0.95f;
        this->ballXMin = clipAreaXLeft + this->ballRadius;
        this->ballXMax = clipAreaXRight - this->ballRadius;
        this->ballYMin = clipAreaYBottom + this->ballRadius;
        this->ballYMax = clipAreaYTop - this->ballRadius;
