...
//    glNormal3dv(bases[11]);
    glVertex3dv(bases[10]);
//    glNormal3dv(bases[10]);
    glEnd();
    glBegin(GL_POLYGON);
    glVertex3dv(bases[11]);
//    glNormal3dv(bases[11]);
...
//    glNormal3dv(bases[15]);
    glVertex3dv(bases[13]);
//    glNormal3dv(bases[13]);
    glVertex3dv(bases[12]);
//    glNormal3dv(bases[12]);
    glVertex3dv(bases[14]);
//    glNormal3dv(bases[14]);
    glEnd();
    glBegin(GL_POLYGON);
    glVertex3dv(bases[5]);
//    glNormal3dv(bases[5]);
...
//    glNormal3dv(bases[17]);
    glVertex3dv(bases[18]);
//    glNormal3dv(bases[18]);
    glVertex3dv(bases[22]);
//    glNormal3dv(bases[22]);
    glVertex3dv(bases[21]);
//    glNormal3dv(bases[21]);
    glEnd();
    glBegin(GL_POLYGON);
    glVertex3dv(bases[19]);
//    glNormal3dv(bases[19]);
    glVertex3dv(bases[23]);
//    glNormal3dv(bases[23]);
    glVertex3dv(bases[20]);
//    glNormal3dv(bases[20]);
    glVertex3dv(bases[16]);
//    glNormal3dv(bases[16]);
    glEnd();
    glBegin(GL_POLYGON);
    glVertex3dv(bases[17]);
//    glNormal3dv(bases[17]);
...
//    glNormal3dv(bases[25]);
    glVertex3dv(bases[27]);
//    glNormal3dv(bases[27]);
    glVertex3dv(bases[31]);
//    glNormal3dv(bases[31]);
    glVertex3dv(bases[29]);
//    glNormal3dv(bases[29]);
    glEnd();
    glBegin(GL_POLYGON);
    glVertex3dv(bases[27]);
//    glNormal3dv(bases[27]);
    glVertex3dv(bases[26]);
//    glNormal3dv(bases[26]);
    glVertex3dv(bases[30]);
//    glNormal3dv(bases[30]);
    glVertex3dv(bases[31]);
//    glNormal3dv(bases[31]);
    glEnd();
    glBegin(GL_POLYGON);
